...
<!--Clients  -->
		<section class="our_client">
			...
			<div class="row">
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/1.png" />"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/2.png" />"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/3.png" />"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/4.png" />"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/5.png" />"></a>
				</div>
				<div class="span2">
					<a href="#"><img alt=""
						src="<c:url value="/template/web/assets/img/6.png"	/>"></a>
				</div>
			</div>
		</section>
